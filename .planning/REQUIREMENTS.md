...
- [~] **ENG-03**: Support workspace file management (upload/download/read/write) for the agent. _(partial: bind-mount infrastructure complete; system prompt lacks /workspace/ path guidance for uploaded files)_
